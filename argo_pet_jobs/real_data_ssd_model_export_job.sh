...
#SBATCH --output=/scratch/akabir4/pet/all_output/export-ssd-real-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/export-ssd-real-%N-%j.error
...
## Export job
PIPELINE_CONFIG_PATH=/scratch/akabir4/pet/real_data/others/ssd_mobilenet_v1_pets.config
CHECKPOINT_NUMBER=4417
python ~/tensorflow-object-detection-api/models/research/object_detection/export_inference_graph.py \
--input_type=image_tensor \
--pipeline_config_path=${PIPELINE_CONFIG_PATH} \
--trained_checkpoint_prefix=/scratch/akabir4/pet/all_output/real_data_ssd_trained_model/model.ckpt-${CHECKPOINT_NUMBER} \
--output_directory=/scratch/akabir4/pet/all_output/real_data_model_exported_ssd
