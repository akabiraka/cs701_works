...
#SBATCH --output=/scratch/akabir4/pet/with_additional_data/output/inference-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/with_additional_data/output/inference-%N-%j.error
...
MY_SCRATCH=/scratch/akabir4/pet/with_additional_data
SPLIT=validation
echo ${MY_SCRATCH}
...
--input_tfrecord_paths=$(ls -1 ${MY_SCRATCH}/tfrecords/${SPLIT}/* | tr '\n' ',') \
--output_tfrecord_path=${MY_SCRATCH}/output/${SPLIT}_detections.tfrecord-00000-of-00001 \
--inference_graph=${MY_SCRATCH}/output/exported_graphs/frozen_inference_graph.pb \
