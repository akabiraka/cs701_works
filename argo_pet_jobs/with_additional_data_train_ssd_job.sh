...
#SBATCH --output=/scratch/akabir4/pet/all_output/with_additional_data_ssd_trained_model/with_additional_data-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/with_additional_data_ssd_trained_model/with_additional_data-%N-%j.error
...
MODEL_DIR=/scratch/akabir4/pet/all_output/with_additional_data_ssd_trained_model
