...
#SBATCH --output=/scratch/akabir4/pet/real_data/output/metric-evaluation-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/real_data/output/metric-evaluation-%N-%j.error
...
--eval_dir=/scratch/akabir4/pet/real_data/evaluation_metics \
