...
#SBATCH --output=/scratch/akabir4/pet/all_output/real-metric-evaluation-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/real-metric-evaluation-%N-%j.error
...
##--eval_dir=/scratch/akabir4/pet/all_output/real_data_ssd_validation_test_evaluation \
##--eval_config_path=/scratch/akabir4/pet/real_data/evaluation_metics/validation_eval_config.pbtxt \
##--input_config_path=/scratch/akabir4/pet/real_data/evaluation_metics/validation_input_config.pbtxt


## Test evaluation metrics generator
python ~/tensorflow-object-detection-api/models/research/object_detection/metrics/offline_eval_map_corloc.py \
--eval_dir=/scratch/akabir4/pet/all_output/real_data_ssd_validation_test_evaluation \
--eval_config_path=/scratch/akabir4/pet/real_data/evaluation_metics/test_eval_config.pbtxt \
--input_config_path=/scratch/akabir4/pet/real_data/evaluation_metics/test_input_config.pbtxt
