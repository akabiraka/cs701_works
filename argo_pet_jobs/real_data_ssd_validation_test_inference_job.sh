...
#SBATCH --output=/scratch/akabir4/pet/all_output/real_inference-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/real_inference-%N-%j.error
...
##--output_tfrecord_path=${MY_SCRATCH}/all_output/real_data_ssd_validation_test_inference/${SPLIT}_detections.tfrecord-00000-of-00001 \
##--inference_graph=${MY_SCRATCH}/all_output/real_data_model_exported_ssd/frozen_inference_graph.pb \
