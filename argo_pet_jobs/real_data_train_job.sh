...
#SBATCH --output=/scratch/akabir4/pet/all_output/real_data_faster_rcnn_resnet101_trained_model/real-faster-rcnn-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/real_data_faster_rcnn_resnet101_trained_model/real-faster-rcnn-%N-%j.error
...
MODEL_DIR=/scratch/akabir4/pet/all_output/real_data_faster_rcnn_resnet101_trained_model
