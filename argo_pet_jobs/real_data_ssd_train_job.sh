...
#SBATCH --output=/scratch/akabir4/pet/all_output/real_data_ssd_trained_model/real-ssd-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/all_output/real_data_ssd_trained_model/real-ssd-%N-%j.error
...
MODEL_DIR=/scratch/akabir4/pet/all_output/real_data_ssd_trained_model
