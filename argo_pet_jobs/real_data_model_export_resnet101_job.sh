...
#SBATCH --output=/scratch/akabir4/pet/real_data/output/export-%N-%j.output
#SBATCH --error=/scratch/akabir4/pet/real_data/output/export-%N-%j.error
...
## Export job
PIPELINE_CONFIG_PATH=/scratch/akabir4/pet/real_data/others/faster_rcnn_resnet101_pets.config
CHECKPOINT_NUMBER=49061
python ~/tensorflow-object-detection-api/models/research/object_detection/export_inference_graph.py \
--input_type=image_tensor \
--pipeline_config_path=${PIPELINE_CONFIG_PATH} \
--trained_checkpoint_prefix=/scratch/akabir4/pet/real_data/output/models/model.ckpt-${CHECKPOINT_NUMBER} \
--output_directory=/scratch/akabir4/pet/real_data/output/exported_graphs
